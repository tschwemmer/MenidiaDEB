...
% Sources: 15-109 dpf is Murray and Baumann 2020, 5dpf is Schwemmer unpub.,
% 322 is Concannon et al 2021
DATA{1} = [1      1
            6       3.9
           16       8.9
           41       24.0
...
X0mat = [1       % the scenarios
         ...
         0.1  ]; % initial weight of buffer in egg
...
par.sJAm = [0.27    1 0 1e6]; % specific assimilation rate 
par.sJM  = [0.015   1 0 1e6]; % specific maintenance costs 
par.WB0  = [0.1    0 0 1e6]; % initial weight of egg
...
par.yVA  = [0.2     1 0 1];   % yield of structure on assimilates (growth)
