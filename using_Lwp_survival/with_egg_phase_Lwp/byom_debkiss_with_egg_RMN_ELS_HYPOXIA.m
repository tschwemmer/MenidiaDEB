...
% % survival means - for plotting only
% DATA{4} = [ 1       8       4       3       2
%             6       0.743   NaN     NaN     NaN
%             7       NaN     0.706   NaN     NaN
%             8       NaN     NaN     0.858   NaN
%             9       NaN     NaN     NaN     0.302
%             21      0.44    NaN     NaN     NaN
%             22      NaN     0.222   NaN     NaN
%             23      NaN     NaN     0.209   NaN
%             24      NaN     NaN     NaN     0];

% add survival data, in proportion surviving at age in dpf. Sources: Cross et al 2019 (24C), Murray and Baumann 2018 (24C), and Murray et al 2017 (17C). 
DATA{4} = [ 1       8       4       3       2
            6       .70     nan     nan     nan
            6       .64     nan     nan     nan
            6       .75     nan     nan     nan
...
X0mat = [8       4       3      2    % the scenarios
        %7.7     4.2     3.1    2.5    % initial oxygen level in mg/L
...
glo.delM  = 0.145; % shape corrector (used in call_deri.m)
...
par.K      = [1.827     1 0 1000]; % correction factor parameter 
par.DOc    = [2.044     0 0 10]; % DO level below which c=0
...
glo.t   = linspace(0,10,300); % time vector for the model curves in days - MIDDLE ENTRY IS MAX TIME, LAST IS NO OF POINTS IN PLOT
