...
par.Lwp  = [23      1 0 1e6]; % shell length at puberty
...
par.mu_emb = [0.05     0 0 1e6]; % mortality rate for embryos
...
glo.t   = linspace(0,20,100); % time vector for the model curves in days - MIDDLE ENTRY IS MAX TIME, LAST IS NO OF POINTS IN PLOT
